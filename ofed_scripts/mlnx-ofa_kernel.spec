...
%if %{build_mthca}
       ...
       echo "MTHCA_LOAD=no" >> /etc/infiniband/openib.conf
%endif

%if %{build_qib}
       echo >> /etc/infiniband/openib.conf
       echo "# Load QIB" >> /etc/infiniband/openib.conf
       echo "QIB_LOAD=no" >> /etc/infiniband/openib.conf
%endif

%if %{build_ipath}
       echo >> /etc/infiniband/openib.conf                                                
       echo "# Load IPATH" >> /etc/infiniband/openib.conf
       echo "IPATH_LOAD=no" >> /etc/infiniband/openib.conf
%endif

%if %{build_ehca}
       echo >> /etc/infiniband/openib.conf                                                
       echo "# Load eHCA" >> /etc/infiniband/openib.conf
       echo "EHCA_LOAD=no" >> /etc/infiniband/openib.conf
%endif
...
%if %{build_cxgb3}
       ...
       echo "CXGB3_LOAD=no" >> /etc/infiniband/openib.conf
%endif

%if %{build_nes}
       echo >> /etc/infiniband/openib.conf                                                
       echo "# Load NES modules" >> /etc/infiniband/openib.conf
       echo "NES_LOAD=no" >> /etc/infiniband/openib.conf
%endif
...
%if %{build_qlgc_vnic}
       ...
       echo "QLGC_VNIC_LOAD=no" >> /etc/infiniband/openib.conf
%endif
